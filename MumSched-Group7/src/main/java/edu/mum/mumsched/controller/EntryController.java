...
import edu.mum.mumsched.helper.AjaxResult;
...
//=======================================================================
//=======This class is responsible to bind Entry entity with its boundary
//=======================================================================
public class EntryController {
	...
	@PostMapping("/save")
	public String saveEntry(@Valid Entry entry, BindingResult bindingResult, Model model, RedirectAttributes rattribute) {
		boolean hasError = bindingResult.hasErrors();
		
		//================================================================================
		//===============The following blocks of codes validate the existence of entry,===
		 //===============the total number of FPP and MPP student==========================
		...
		// redirect message
		msgService.addRedirectMessage(rattribute, entry.getId() == 0 ? 
